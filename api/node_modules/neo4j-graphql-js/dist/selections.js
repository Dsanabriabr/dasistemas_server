...
function buildCypherSelection(_ref) {
  ...
  if (innerSchemaType && innerSchemaType.astNode && innerSchemaType.astNode.kind === 'InterfaceTypeDefinition') {
    ...
    var implementationName = fragment ? fragment.typeCondition.name.value : interfaceName;
  ...
  if (customCypher) {
    ...
    if (filterParam) {
      subSelection[1][filterParamKey] = (0, _translate.transformExistentialFilterParams)(filterParam);
    }
